...
topFrame = tk.Frame(root, bg=color["primary"], bd=1, relief=tk.RIDGE)
...
brandLabel = tk.Label(root, text="Pythonista\nEmpire", font="System 30", bg="gray17", fg="green", bd=1, relief=tk.RIDGE)
brandLabel.place(x=100, y=250)
...
navRoot = tk.Frame(root, bg=color["red"], height=1000, width=300, bd=1, relief=tk.RIDGE)
navRoot.place(x=-300, y=0)
tk.Label(navRoot, font="Bahnschrift 15", bg=color["red"], fg="black", height=2, width=300, padx=20).place(x=0, y=0)
y = 80
